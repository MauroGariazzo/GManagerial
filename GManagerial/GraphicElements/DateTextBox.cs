        ...
        private void BarlineLogic(KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar != (char)Keys.Back)
            {
                ...
                if (char.IsDigit(e.KeyChar))
                {
                    ...
                    {
                        if ((this.Text.Length == 2 || this.Text.Length == 5) && this.Text.Count(c => c == '/') < 2)
                        {
                            this.Text = this.Text.Insert(this.Text.Length, "/" + e.KeyChar);
                            this.SelectionStart = selectionStart + 2;
                        }

                        else if((this.Text.Length == 2 || this.Text.Length == 5) && this.Text.Count(c => c == '/') == 2)
                        {
                            this.Text = this.Text.Insert(selectionStart, e.KeyChar.ToString());
