...
namespace GManagerial.QuoteDocForms.ChildForms
{
    ...
    internal partial class AddProduct : Form
    {
        ...
        private void PassProductIdToWarehouseProduct(int product_fk)
        {
            ...
            //_wareHouseProduct = product;
            _wareHouseProduct.PassProductMembers(product);
        ...
        private void okBtn_Click(object sender, EventArgs e)
        {
            if (productsLB.SelectedIndex != -1)
            {
                ProductInformationsForQuoteDocument productInformation = new ProductInformationsForQuoteDocument(_product, IsNewEditCopyDeleteEnum.New, CloseForm);
